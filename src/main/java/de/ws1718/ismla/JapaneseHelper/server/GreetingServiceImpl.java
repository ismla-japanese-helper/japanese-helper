...
public class GreetingServiceImpl extends RemoteServiceServlet implements GreetingService {
	...
	// requires the file inside the directory to have been generated by WiktionaryPreprocessor
	...
	private void readTokens() {
		tokens = new HashSet<>();
		String line;
		List<String> dictFileList = new ArrayList<String>(getServletContext().getResourcePaths(DICTIONARY_GENERATED_PATH));
		// size == 1
