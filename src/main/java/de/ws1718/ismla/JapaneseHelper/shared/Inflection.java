...
/**
 * The names of the inflection forms, 
 * as given in the Wikionary inflection table templates.
 */
public enum Inflection implements Serializable {
	...
	INFORMAL_NEGATIVE, INFORMAL_PAST, INFORMAL_NEGATIVE_PAST, FORMAL_NEGATIVE, FORMAL_PAST, 
	FORMAL_NEGATIVE_PAST, CONDITIONAL, PROVISIONAL, ADVERBIAL, DEGREE,
	// alternative forms
