...
public class GlossesTest {
    public static void main(String[] args) {
        Token t = new Token();
        ArrayList<String> results1 = t.processGlossesTester("1) a land, a large place 2) a country in general, a region 3) a country as in a nation, a state 4) the office of emperor, the crown; affair s of state 5) a province of ancient Japan 6) the national  government in ancient Japan; the national capital in ancient Japan 7) one's birthplace");
        ArrayList<String> results2 = t.processGlossesTester("1) ? 2) to sleep 3) to leave");
        ArrayList<String> results3 = t.processGlossesTester("1) ? 2) ? 3) ? 4) loss 5) barrel");
